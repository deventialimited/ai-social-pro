...
const PostSchema = new Schema({
  ...
  platform: { 
    type: String, 
    default: "Facebook",
    enum: ["Facebook", "Instagram", "Twitter", "LinkedIn", "Pinterest", "TikTok", "Other"]
  },
  ...
  shapes: [{
    ...
    type: { type: String, default: 'rectangle', enum: ['rectangle', 'circle', 'triangle', 'text', 'line', 'custom'] },
    ...
    borderStyle: { type: String, default: 'solid', enum: ['solid', 'dashed', 'dotted', 'none'] },
