  ...
  export const SocialsTab = () => {
    ...
    const handleDisconnect = async () => {
      ...
      // Map platform keys to their corresponding disconnect URLs
      const disconnectUrls = {
        ...
        x: "https://oneyearsocial.com/disconnectTwitter", // Note: 'x' is mapped to Twitter URL
      ...
      try {
        ...
        if (disconnectUrl) {
          ...
          if (!response.ok) {
            throw new Error(
              `Failed to disconnect from ${platformToDisconnect}`
            );
          }
        }
