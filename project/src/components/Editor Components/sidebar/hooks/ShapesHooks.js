...
export const hardCodedShapes = [
  {
    id: "star",
    name: "Star",
    svg: `<svg viewBox="0 0 24 24" fill="black" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    name: "Hexagon",
    svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <polygon points="50,10 90,30 90,70 50,90 10,70 10,30" fill="black"/>
      </svg>`,
  },
  {
    id: "arrow",
    name: "Arrow",
    svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <path d="M10 50h60l-20 -20v15h-40v10h40v15z" fill="black"/>
      </svg>`,
  },
  {
    id: "cross",
  ...
  },
  {
    ...
    svg: `<svg viewBox="0 0 32 29.6" xmlns="http://www.w3.org/2000/svg">
        ...
        C26.8,20.9,32,16.1,32,10.4C32,4.7,27.3,0,21.6,0H23.6z" fill="black"/>
      </svg>`,
  },
  {
    id: "cloud",
    ...
    svg: `<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
        <path d="M48,24a16,16,0,0,0-31.73-2A12,12,0,0,0,16,48H48a12,12,0,0,0,0-24Z" fill="black"/>
      </svg>`,
  },
];
