...
import { useUpdateDomainBusiness, uploadLogoToDomain } from "../libs/domainService";
...
const updateBrandMutation = useMutation({
  ...
  onSuccess: (data) => {
    ...
    // maybe refetch domain or show toast
  },
  onError: (err) => {
  ...
  try {
    const colors = [formData.brandColor, formData.backgroundColor, formData.textColor];
