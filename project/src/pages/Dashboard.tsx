...
const samplePosts: Post[] = [
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?auto=format&fit=crop&w=1000',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?auto=format&fit=crop&w=1000',
  ...
  // Twitter (X) Posts
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=1000',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1516054575922-f0b8eeadec1a?auto=format&fit=crop&w=1000',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1489549132488-d00b7eee80f1?auto=format&fit=crop&w=1000',
  ...
  // LinkedIn Posts
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1501785888041-af3ef285b470?auto=format&fit=crop&w=1000',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&w=1000',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?auto=format&fit=crop&w=1000',
...
const sampleBusinessData: BusinessData = {
  name: 'Kaz Routes',
  description: 'A company that provides travel and tourism-related services, specializing in routes and guided experiences across Kazakhstan.',
...
export const Dashboard: React.FC = () => {
  ...
  const [postsTab, setPostsTab] = useState<'generated' | 'draft' | 'scheduled' | 'published'>('generated');
  ...
  const filteredPosts = posts.filter(post => {
    const matchesFilter = filter === 'all' || post.platforms.includes(filter as any);
          ...
          <div className="space-y-6 mt-6">
            ...
            <div className={`max-w-[1200px] mx-auto px-4 sm:px-6 ${
              ...
              {filteredPosts.map((post) => (
                <div key={post.id} className={view === 'list' ? 'w-full max-w-[680px]' : 'w-full'}>
                  <PostCard
                    post={post}
                    onEdit={handleEdit}
  ...
  return (
    <div className={isDark ? 'dark' : ''}>
      <div className="min-h-screen bg-light-bg dark:bg-dark-bg">
        ...
        <div className={`transition-all duration-300 lg:ml-64 pt-20 pb-8 ${isMobileMenuOpen ? 'ml-64' : 'ml-0'}`}>
          {renderContent()}
        </div>
